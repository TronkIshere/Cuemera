...
const Map<CoachingAttribute, List<String>> kAttributeTopicKeywords = {
  ...
  CoachingAttribute.rightArmPosition: ['arm', 'arms', 'elbow'],
  CoachingAttribute.leftArmPosition: ['arm', 'arms', 'elbow'],
...
const Map<CoachingAttribute, String> kAttributeHumanName = {
  ...
  CoachingAttribute.rightArmPosition: 'right arm position',
  CoachingAttribute.leftArmPosition: 'left arm position',
